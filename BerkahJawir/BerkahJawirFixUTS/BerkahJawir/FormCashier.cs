    ...
    public partial class FormCashier : Form
    {
        ...
        private void cb_barang_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cb_barang.SelectedIndex == 0)
            {
                ...
                tb_harga.Text = "100000";
                pictureBox1.Image = Image.FromFile(@"D:\XI\image\semen.jfif");
            ...
            else if (cb_barang.SelectedIndex == 1)
            {
                cb_barang.Text = "Paku";
                tb_harga.Text = "50000";
                pictureBox1.Image = Image.FromFile(@"D:\XI\image\paku.jfif");
                pictureBox1.SizeMode = PictureBoxSizeMode.StretchImage;
            }
            ...
            else if (cb_barang.SelectedIndex == 2)
            {
                cb_barang.Text = "Cat";
                tb_harga.Text = "80000";
                pictureBox1.Image = Image.FromFile(@"D:\XI\image\cat.jfif");
                pictureBox1.SizeMode = PictureBoxSizeMode.StretchImage;
            }
            ...
            else if (cb_barang.SelectedIndex == 3)
            {
                ...
                tb_harga.Text = "45000";
                pictureBox1.Image = Image.FromFile(@"D:\XI\image\kawat.jfif");
                pictureBox1.SizeMode = PictureBoxSizeMode.StretchImage;
            }
            ...
            {
                cb_barang.Text = "Seng";
                tb_harga.Text = "200000";
                pictureBox1.Image = Image.FromFile(@"D:\XI\image\seng.jfif");
                pictureBox1.SizeMode = PictureBoxSizeMode.StretchImage;
            }
